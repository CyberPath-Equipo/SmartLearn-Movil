...
public class LoginResponse {
    ...
    public String getLabelNombre() { return labelNombre; }
    public void setLabelNombre(String labelNombre) { this.labelNombre = labelNombre; }
    ...
    public String getTwoFactorTransactionId() { return twoFactorTransactionId; }
    public void setTwoFactorTransactionId(String twoFactorTransactionId) { this.twoFactorTransactionId = twoFactorTransactionId; }
