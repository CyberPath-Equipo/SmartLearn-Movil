...
public class SalidaAudio implements TextToSpeech.OnInitListener {
        ...
        if (status == TextToSpeech.SUCCESS) {
            ...
            motorTts.setOnUtteranceProgressListener(new UtteranceProgressListener() {
                ...
                public void onDone(String utteranceId) {
                    ...
                    // Ejecutar callback en hilo principal (IMPORTANTE)
    ...
    public void hablar(String texto, boolean interrumpir, Runnable onDone) {
        ...
        this.onSpeechDone = onDone; // Asignar callback
    ...
    public void detener() {
        if (tts != null && tts.isSpeaking()) {
            ...
            // Ejecutar callback si se detiene manualmente (en hilo principal)
            final Runnable cb = onSpeechDone;
            if (cb != null) {
                mainHandler.post(cb);
                onSpeechDone = null;
    ...
    // útil para quien necesite comprobar estado
